...
type Artwork = { id: string; title: string; description: string | null; year: number | null; medium: string | null; dimensions: string | null; priceAmount: number | null; currency: string | null; isPublished: boolean; images: Array<{ id: string; alt: string | null; asset: { url: string } }>; };
