...
export function GetStartedEntryPoint() {
  ...
  return (
    <div className="rounded border bg-zinc-50 p-4">
      <p className="text-sm text-zinc-700">Finish your setup: {progress.completedCount}/{progress.totalCount} done.</p>
      <Link href="/get-started" className="mt-2 inline-block rounded border bg-white px-3 py-1 text-sm">
        Get started
      </Link>
    </div>
  );
