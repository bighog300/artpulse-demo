...
export function VenueGalleryLightbox({ images }: { images: GalleryImage[] }) {
  ...
  return (
    <section className="space-y-3">
      <div className="flex items-center justify-between gap-2">
        ...
        <p className="text-sm text-zinc-600">{images.length} photos</p>
      </div>
      ...
      {selectedImage ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4" role="dialog" aria-modal="true" aria-label="Venue photo preview">
