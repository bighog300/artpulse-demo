        ...
        <div className="flex flex-col gap-3 p-4 md:p-6">
          <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
            <div className="space-y-1">
              ...
              {locationText ? <p className="text-sm text-muted-foreground">{locationText}</p> : null}
            </div>
          ...
          {description ? <p className="text-sm text-muted-foreground line-clamp-3">{description}</p> : null}
        </div>
      </div>
    </section>
  );
